...
tictoc::tic()
set.seed(1)
cadena1_M1 <- MCMC_1(B = 20000, nj, yb, s2)
cadena2_M1 <- MCMC_1(B = 20000, nj, yb, s2)
cadena3_M1 <- MCMC_1(B = 20000, nj, yb, s2)
tictoc::toc()
```
...
tictoc::tic()
set.seed(1)
cadena1_M2 <- MCMC_2(B = 20000, nj, yb, s2)
cadena2_M2 <- MCMC_2(B = 20000, nj, yb, s2)
cadena3_M2 <- MCMC_2(B = 20000, nj, yb, s2)
tictoc::toc()
```
...
# posterior nu
plot (1:15, as.numeric(table(factor(x = cadena1_M2$THETA$nu, levels = 1:15)))/20000, type = "b", pch = 20, col = col[2], xlab = expression(nu), ylab = "Densidad", main = expression(nu))
lines(1:15, as.numeric(table(factor(x = cadena2_M2$THETA$nu, levels = 1:15)))/20000, type = "b", pch = 20, col = col[2])
lines(1:15, as.numeric(table(factor(x = cadena3_M2$THETA$nu, levels = 1:15)))/20000, type = "b", pch = 20, col = col[2])
# posterior sigma^2
