...
**El Teorema de Bayes, haciendo intuitiva la Probabilidad** (3Blue1Brown): https://www.youtube.com/watch?v=HZGCoVF3YvM&t=814s&ab_channel=3Blue1Brown
...
$$
\ell(\theta) = c\,p(\boldsymbol{y}\mid\boldsymbol{\theta}),
$$ 
