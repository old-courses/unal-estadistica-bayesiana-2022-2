...
## Ejemplo: Diagnosticos de convergencia
...
```{r, fig.width=8, fig.height=4, fig.height=5}
# autocorrelacion
...
```{r}
# tamaño efectivo de la muestra
apply(X = PHI, MARGIN = 2, FUN = sd)/coda::effectiveSize(PHI)
```

Ver https://cran.r-project.org/web/packages/bayesplot/vignettes/visual-mcmc-diagnostics.html para más diagnosticos.
